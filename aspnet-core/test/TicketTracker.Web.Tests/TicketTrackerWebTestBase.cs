...
{
    public abstract class TicketTrackerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TicketTrackerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TicketTrackerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TicketTrackerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TicketTrackerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TicketTrackerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TicketTrackerDbContext, Task<T>> func)
        {
            T result;
