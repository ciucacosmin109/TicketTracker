...
namespace TicketTracker.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TicketTrackerConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags us"),
                new ApplicationLanguage(tenantId, "ro", "Romană", "famfamfam-flags ro"),
                /*
        ...
        public DefaultLanguagesCreator(TicketTrackerDbContext context)
        {
            _context = context;
        }
